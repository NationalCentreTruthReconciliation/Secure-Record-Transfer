...
class Metadata(models.Model):
    ...
    * :py:class:`~caais.models.DateOfCreationOrRevision` [CAAIS, Section 7.2]
    ...
    accession_title = models.CharField(
        ...
        verbose_name=_("Accession title"),
    )
    ...
    date_of_materials = models.CharField(
        ...
        verbose_name=_("Date of materials"),
    )

    date_is_approximate = models.BooleanField(
        null=False,
        default=False,
        verbose_name=_("Date is approximate"),
    )
    ...
    rules_or_conventions = models.CharField(
        ...
        verbose_name=_("Rules or conventions"),
    )
    ...
    language_of_accession_record = models.CharField(
        ...
        verbose_name=_("Language of accession record"),
    )
...
class Identifier(models.Model):
    ...
    identifier_note = models.TextField(
        ...
        verbose_name=_("Identifier note"),
    )
...
class SourceOfMaterial(models.Model):
    ...
    postal_or_zip_code = models.CharField(
        ...
        blank=True,
        default="",
        verbose_name=_("Postal or zip code"),
    )
...
class ExtentStatement(models.Model):
    ...
    quantity_and_unit_of_measure = models.TextField(
        ...
        verbose_name=_("Quantity and unit of measure"),
    )
...
class RightsType(AbstractTerm):
    ...
    class Meta(AbstractTerm.Meta):
        ...
        verbose_name_plural = _("Rights types")
        verbose_name = _("Rights type")
...
class PreservationRequirementsType(AbstractTerm):
    ...
    class Meta(AbstractTerm.Meta):
        ...
        verbose_name_plural = _("Preservation requirements types")
        verbose_name = _("Preservation requirements type")
...
class PreservationRequirements(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Preservation requirements")
        verbose_name = _("Preservation requirement")
    ...
    preservation_requirements_value = models.TextField(
        ...
        verbose_name=_("Preservation requirements value"),
    )
    ...
    preservation_requirements_note = models.TextField(
        ...
        verbose_name=_("Preservation requirements note"),
    )
...
class AppraisalType(AbstractTerm):
    ...
    class Meta(AbstractTerm.Meta):
        ...
        verbose_name_plural = _("Appraisal types")
...
class Appraisal(models.Model):
    ...
    appraisal_value = models.TextField(
        ...
        verbose_name=_("Appraisal value"),
    )
...
class AssociatedDocumentationType(AbstractTerm):
    ...
    class Meta(AbstractTerm.Meta):
        ...
        verbose_name_plural = _("Associated documentation types")
        verbose_name = _("Associated documentation type")
...
class AssociatedDocumentation(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Associated documentation")
        verbose_name = _("Associated documentation")
    ...
    associated_documentation_title = models.TextField(
        ...
        verbose_name=_("Associated documentation title"),
    )
    ...
    associated_documentation_note = models.TextField(
        ...
        verbose_name=_("Associated documentation note"),
    )
...
class CreationOrRevisionType(AbstractTerm):
    ...
    class Meta(AbstractTerm.Meta):
        ...
        verbose_name = _("Creation or revision type")
        verbose_name_plural = _("Creation or revision types")
...
class DateOfCreationOrRevision(models.Model):
    ...
    class Meta:
        ...
        verbose_name = _("Date of creation or revision")
        verbose_name_plural = _("Dates of creation or revision")
    ...
    creation_or_revision_date = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_("Creation or revision note"),
    )
    ...
    creation_or_revision_agent = models.CharField(
        ...
        verbose_name=_("Creation or revision agent"),
    )
