...
from django.db.models import Aggregate, Case, CharField, F, Q, Value, When
...
class GroupConcat(Aggregate):
    ...
    def __init__(self, expression: object, separator: str = ",", **extra):
...
class DefaultConcat(GroupConcat):
    ...
    def __init__(self, expression: object, **extra):
...
class CharFieldOrDefault(Case):
    ...
    def __init__(self, field_name: str, default_str: str = "NULL"):
        # field_name=''
        empty = {field_name: ""}
        # field_name__isnull=True
        isnull = {f"{field_name}__isnull": True}
