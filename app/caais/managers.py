...
class MetadataManager(models.Manager):
    def flatten(self, version=Columns.CAAIS_1_0) -> dict:
...
class CaaisModelManager(models.Manager, ABC):
    ...
    @abstractmethod
    def flatten_atom(self, version: Columns) -> dict:
        """Flatten metadata to be used for AtoM"""

    @abstractmethod
    def flatten_caais(self, version: Columns) -> dict:
        """Flatten metadata to be used for CAAIS"""

    def flatten(self, version: Columns = Columns.CAAIS_1_0) -> dict:
        """Flatten metadata to be used in BagIt metadata or CSV file"""
        data = None
        if version == Columns.CAAIS_1_0:
...
class IdentifierManager(CaaisModelManager):
    ...
    def flatten_atom(self, version: Columns) -> dict:
        ...
        if version in (Columns.ATOM_2_1, Columns.ATOM_2_2, Columns.ATOM_2_3):
            return {}
