...
UPLOAD_SESSION_MAX_CONCURRENT_OPEN = config(
    "UPLOAD_SESSION_MAX_CONCURRENT_OPEN", default=8, cast=int
)
...
IN_PROGRESS_SUBMISSION_PRISTINE_RETENTION_MINUTES = config(
    "IN_PROGRESS_SUBMISSION_PRISTINE_RETENTION_MINUTES", default=60, cast=int
)

IN_PROGRESS_SUBMISSION_PRISTINE_CLEANUP_SCHEDULE = config(
