...
class TestUploadSession(TestCase):
    ...
    @patch("upload.models.UploadSession.permuploadedfile_set", spec=BaseManager)
    ...
    @patch("upload.models.UploadSession.get_temporary_uploads")
    ...
    @patch("upload.models.UploadSession.get_uploads")
    @patch("upload.models.get_human_readable_file_count")
    @patch("upload.models.get_human_readable_size")
